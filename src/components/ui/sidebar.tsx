...
function Sidebar({
    ...
    return (
        ...
        >
            <div
                className={cn(
                    "duration-300 relative w-(--sidebar-width) bg-transparent transition-[width] ease-in-out",
            ...
            >
                <div
                    data-sidebar="sidebar"
                    className="justify-center p-1 flex h-full w-full flex-col bg-sidebar group-data-[variant=floating]:rounded-md group-data-[variant=floating]:border group-data-[variant=floating]:border-sidebar-border group-data-[variant=floating]:shadow-sm"
                >
                    {children}
                </div>
            </div>
