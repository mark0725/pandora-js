...
import {
    Bar, BarChart, CartesianGrid, XAxis, AreaChart, Area, PieChart, Pie, Label, PolarGrid,
    PolarRadiusAxis,
    RadialBar,
    RadialBarChart, 
} from "recharts"
...
export function DashboardPageLayout(props: DashboardPageLayoutProps) {
    ...
    return (
        <div className="h-full grid flex-1  gap-1 2xl:gap-2 grid-rows-4 grid-cols-4 overflow-hidden">
            <div className="flex col-span-2 row-span-2 overflow-hidden">
            <Card className="flex-1 rounded-sm">
            <CardHeader className="flex-1 flex flex-col items-stretch space-y-0 border-b p-0 sm:flex-row">
        ...
        <Card className="flex-1 rounded-sm">
            ...
            <div className="flex col-span-2 row-span-2 overflow-hidden">
            <Card className="flex-1 rounded-sm overflow-hidden">
